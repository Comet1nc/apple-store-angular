...
import { ConfiguratedOption, ProductConfiguratorService } from '../../service/product-configurator.service';
...
export class SummaryComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.configuratorService.onAllOptionsSelected.subscribe(([expression, data]) => {
